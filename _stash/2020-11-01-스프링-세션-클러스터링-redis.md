...
스프링 세션을 프로젝트에 적용하는 방법은 공식 가이드의 설명(https://docs.spring.io/spring-session/docs/current/reference/html5)으로 대체하고, 이 포스트에서는 스프링 세션 REDIS 에서 세션을 어떠한 자료구조로 저장을 하는 지에 대한 분석한 내용을 정리한다. 
