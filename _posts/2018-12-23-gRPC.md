...
gRPC 는 http2 를 기반으로 사용됩니다. 결국 gRPC 를 이해한다는 것은 http2 에 대해서도 알아간다는 것을 의미합니다. 때문에 http2의 이해가 없으면 이해하기가 어려운 이유로, gRPC 외에도 http2 에 대한 이야기도 짤막하게 다루어봅니다.
