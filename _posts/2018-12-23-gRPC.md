...
gRPC는 http2 를 기반으로 사용하는 RPC 프레임워크입니다. gRPC 를 사용한다는 것은 http2 에 대해서도 알아간다는 것을 의미하며, http2의 이해가 없으면 gRPC를 이해하기에 난해합니다. 때문에 이 아티클에서는 gRPC 외에도 http2 에 대한 이야기도 짤막하게 다루어봅니다.
