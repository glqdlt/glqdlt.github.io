...
여담이지만 http2 를 보고 statefull 인지, stateless 인지에 대한 헷갈려 하는 토픽들을 많이 볼 수 있습니다. 기본적으로 http2 는 기존 http1.1 과 마찬가지로 restfull 이며 (stateless) 많이들 오해하는 http2 는 세션을 계속 물고 있을 것이라는 것은 keep alive 에 설정에 의해 커넥션을 오래 물고 있을 수 있는 형태일 뿐, 다를 바가 없습니다. 
