...
Application Layer 에서는 .proto 파일을 정의해서 Proto Buffer를 통해 구현체들을 generated 한다. 이 generated 된 산출물들은(자바의 경우 .class) gRPC Core 를 통해 Http 2 구현 Server 들 위에 올라가게 되는 데, 이 과정의 제어와 서포트는 gRPC Core 에서 담당하는 구조.
