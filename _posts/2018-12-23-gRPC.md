...
이런 http2의 특징은 gRPC 에서도 그대로 똑같이 적용 되며, gRPC의 peer 간의 커넥션은 지속적으로 맺고 있게 되고, RPC 사용(메세지 요청)이 있을 때에만 리소스의 사용이 발생하게 됩니다. 
...
- BIDI_STREAMING : 양방향 스트리밍
    ...
    N개의 응답과 요청이 있습니다. 각각의 응답과 요청은 독립적인 스트림 안에서 pair 를 맺으며, 순서 추적이 보장됩니다.
