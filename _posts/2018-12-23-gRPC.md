...
위에 대한 내용은 (JAVA 소스 기준) MethodType Enum 에서도 자세한 설명을 얻을 수 있습니다.
...
실제로 client 에서 call 을 요청하기 전을 후킹하는 인터셉터를 걸어서 해당 call이 어떠한 Method Type 인지를 출력해보면 아래와 같은 정보를 얻을 수 있습니다.
