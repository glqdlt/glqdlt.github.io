...
gRPC는 Google 에서 만든 [RPC(Remote Procedure Call)](https://ko.wikipedia.org/wiki/%EC%9B%90%EA%B2%A9_%ED%94%84%EB%A1%9C%EC%8B%9C%EC%A0%80_%ED%98%B8%EC%B6%9C) 프레임워크 입니다. gRPC란 이름은 단순하게 google + RPC 란 의미를 가지고 있습니다.
