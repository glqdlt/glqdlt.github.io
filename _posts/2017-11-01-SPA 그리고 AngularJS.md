...
일단 방금도 얘기 했듯이 분식집의 주방 이모들님들에게 일본식 라멘 제조법을 설명해야 하는 상황이었다. 사실 팀원 분들은 국내에서도 알아주는 내놓으라는 엔지니어의 집단이다, 이런 분들에게 주방 이모님들과 비유한다는 것 자체가 실례일 수 있다. 팀 동료들도 Angular 든 ReactJS든 이름은 많이 들어봤을 텐데, 굳이 필요성에 대해서 인지를 못하기에 선듯 관심을 가지진 못했을 수도 있다. 나 역시도 누구라도 알법한 엔터프라이즈 웹 서비스의 엔지니어가 되보고자 노력했던 시간이 없더라면 관심도 가지질 않았을 것이다.
