...
me 는 제 개인적으로는 많이 생소한 편이었는데, 소형 임베디드에서 구동 될 java 를 뜻 하고 있습니다. 대표적으로 소형 기기에서의 사용을 볼 수 있습니다. TV 나 라디오 등을 들 수가 있겠습니다, 재밌는 것은 Java me 의 JSR 을 보면 Mobile 기기에 대한 정의도 있습니다. 여기서 생각해 볼 만한 것이 설마 android Os 는 java me 를 구현한 것인걸까? 하는 의문을 가질 수도 있습니다만 이 2가지는 전혀 별개의 다른 존재입니다. 

android 는 java 문법을 사용할 수 있지만 dalvik vm (지금은 Android RunTime 으로 변경 )을 기반으로 어플리케이션이 실행 됩니다. java me 는 최근에 거의 사용 되고 있지지 않은 추세입니다, 과거에 몇몇 모바일 폰에서 사용이 되곤 했습니다.
