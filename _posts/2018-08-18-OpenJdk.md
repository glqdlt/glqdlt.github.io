...
se 는 자바의 기준(레퍼런스) 이라는 의미를 뜻하는 스펙은 아니고, 자바를 개발한 썬에서 (지금은 Oracle 이 인수) 
...
과 같은 비지니스 기능 별 모델을 나누는 전략을 취하면서 만들어진 이름입니다. 정확한 의미로는 자바 기본 사양이라고 볼 수 있겠습니다. (기준과 기본 사양의 의미가 같아보이기도 하지만 -_-;;)
