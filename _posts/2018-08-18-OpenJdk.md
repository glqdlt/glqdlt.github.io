...
개인적으로 생각하기에 앞으로의 생길 상황을 정리하면 이러합니다. 올해까지 BCL 라이센스에 동의하고 합법적으로 받은 OracleJDK는 그냥 사용해도 됩니다. 또한 현재 가장 인기 있는 OracleJDK SE 8 에 대해서는 2020년까지의 업데이트를 약속하였으니 업데이트 받아 사용해도 됩니다. 
