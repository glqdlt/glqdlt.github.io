...
특히 벌써부터 새로이 개발 된 Java 11 버전 이후에는 BCL 라이센스가 아닌 [Oracle Technology Network License](https://www.oracle.com/technetwork/java/javase/terms/license/javase-license.html) 로 갱신되어 있습니다. 
...
응용 프로그램 개발, 테스트, 프로토 타이핑 및 시연 이외의 모든 데이터 처리 또는 상업적, 생산적 또는 내부 비즈니스에서의 프로그램 실행을 할 수가 없다.

Oracle Technology Network License 는 개인적인 (가정에서의) 사용에는 기존과 같이 무료이지만, 상업적인 공간에서의 사용에 대한 제한성이 대폭 강화되었습니다. 예전의 BCL 라이센스가 아닌 Oracle Technology Network License 로 갱신 된 버전의 OracleJDK 의 사용이 개발 환경에서도 사용이 어려워졌습니다.
