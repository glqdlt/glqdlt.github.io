...
me 는 제 개인적으로는 많이 생소한 편이었습니다. me는 소형 임베디드에서 구동 될 java 를 뜻 하고 있으며, Java me 의 JSR 에서 알 수 있듯 Mobile 기기에 대해서도 정의 도 있는 것을 확인해 볼 수 있습니다. 이 부분에 대해 혹시나 하며 생각 해 볼 만한 것으로 android Os 는 java me 를 구현한 것인걸까? 하는 의문을 가질 수도 있습니다. 하지만 이 2가지는 전혀 별개의 다른 존재입니다. 
