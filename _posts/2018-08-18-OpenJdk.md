...
기본적으로 zulu는 오픈 소스 프로젝트로 운영되고 있으며 당연히 무료 입니다. 별도의 유료 모델로 과거 Oracle 의 기존 유료 구매와 비슷한 [zulu enterprize](https://www.azul.com/products/zulu-enterprise/)가 있으며, hotspot 과 동등하거나 그 이상의 퍼포먼스를 가진다는 유료 JVM인 [zing](https://www.azul.com/products/zing/) 이 있습니다. 
...
지금 많이 사용 되는 Oracle SE 8 을 예로 들면 2019년 01월 부터는 새로운 라이센스(BCL과 다른)가 적용 될 것이나, 무료 개인 사용을 목적으로 하는 사용자에 한해서 기존처럼 보안 업데이트는 2020년 까지 지원을 해줄 것이고, 그 외의 경우는 모두 유료 구독라이센스를 받아야 한다는 것입니다.

특히 벌써부터 새로이 개발 된 Java 11 버전 이후에는 BCL 라이센스가 아닌 Oracle Network License 로 갱신되고 유료 다운로드 형태로만 제공되고 있습니다. 결국 이는 OracleJDK 의 유료로의 전환을 일컫습니다. (유료 사용자는 2019년 01월 부터 기존 유료 다운로드 페이지에서, 새로운 구독 사용자 전용 다운로드 페이지를 제공합니다.)
...
OracleJDK는 개발 환경에 관해서는 무료입니다. 올해까지 제공 되는 BCL 라이센스 기반의 버전에 대해서는 OracleJDK는 그냥 사용해도 됩니다. 
